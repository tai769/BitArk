...
import com.bitark.recover.RecoveryConfig;
...
public class ReadServiceImpl implements ReadService {
    ...
    public ReadServiceImpl(WalEngine walEngine, RecoveryConfig recoveryConfig, RestTemplate restTemplate) throws Exception {
